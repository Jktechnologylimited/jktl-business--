...
import { Camera, Loader2, Scissors, X } from "lucide-react";
import { fileToSquareDataUrl } from "@/lib/image";
import { useToastStore } from "@/lib/toast";

/** Square service photo shown on the public website's services section.
 * Same client-crop-then-upload-on-save pattern as `ProductPhotoField`. */
export function ServicePhotoField({ value, onChange }: { value: string | null; onChange: (dataUrl: string | null) => void }) {
    ...
    <div className="flex items-center gap-4">
      <div className="relative">
        {value ? (
          ...
          <img src={value} alt="Service" className="size-16 rounded-2xl border border-border-strong object-cover" />
        ) : (
        ...
        <button
          ...
          aria-label="Change service photo"
        >
