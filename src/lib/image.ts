/**
 * Reads an image file, downsizes it to a square (center-cropped) JPEG at
 * `size`px, and resolves a data URL. Keeps uploaded photos small enough to
 * comfortably live in localStorage alongside the session.
 */
